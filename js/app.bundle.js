...
const countryModal = new CountryModal();
...
class CalculatorView {
  ...
  getEffectiveRate(rateObj) {
    if (!rateObj) return 1;
    // Usar tasa del día siguiente si está publicada; si no, usar la tasa de hoy como referencia
    if (this.selectedDay === 'prediccion') {
